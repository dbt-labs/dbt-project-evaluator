...
select 
    ...
    cast(null as {{ dbt.type_string() }}) as incremental_strategy,
    cast(null as {{ dbt.type_string() }}) as partition_by,
    cast(null as {{ dbt.type_string() }}) as persist_docs,
    cast(null as {{ dbt.type_string() }}) as full_refresh,
