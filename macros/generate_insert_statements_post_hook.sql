{% macro generate_insert_statements_post_hook(relation, resource_type='nodes', relationships=False, batch_size=var('insert_batch_size', 500 if target.type == 'bigquery' else 10000)) %}
