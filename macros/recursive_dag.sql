...
all_relationships (
    ...
    select distinct
        ...
        package_name as parent_package_name,
        ...
        package_name as child_package_name,
    ...
    select  
        ...
        all_relationships.parent_package_name as parent_package_name,
        ...
        direct_relationships.package_name as child_package_name,
...
, cte_{{i}} as (
    select 
        ...
        direct_relationships.resource_id as child_id,
        direct_relationships.package_name,
        direct_relationships.materialized as child_materialized,
...
, all_relationships as (
    select
        ...
        child.package_name as child_package_name,
