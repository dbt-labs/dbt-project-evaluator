    ...
    {%- for node in nodes_list -%}
        ...
        {%- set values_line  = 
            [
                ...
                wrap_string_with_quotes(node.config.incremental_strategy),
                wrap_string_with_quotes(node.config.partition_by | tojson),
                wrap_string_with_quotes(node.config.persist_docs | tojson),
                wrap_string_with_quotes(node.config.full_refresh),
