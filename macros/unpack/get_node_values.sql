    ...
    {%- for node in nodes_list -%}
        ...
        {%- set values_line  = 
            [
                ...
                "cast(" ~ (node.columns.values() | list | length) ~ " as " ~ dbt.type_int() ~ ")",
                "cast(" ~ (node.columns.values() | list | selectattr('description') | list | length) ~ " as " ~ dbt.type_int() ~ ")",
                ...
                "cast(" ~ number_lines ~ " as " ~ dbt.type_int() ~ ")",
                "cast(" ~ sql_complexity ~ " as " ~ dbt.type_float() ~ ")",
