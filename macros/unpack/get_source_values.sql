        ...
        {%- set exclude_source = dbt_project_evaluator.set_is_excluded(node, resource_type="source") -%}
         ...
         {%- set values_line = 
            [
              ...
              wrap_string_with_quotes(node.source_description),
              wrap_string_with_quotes(node.description),
              ...
              wrap_string_with_quotes(dbt.escape_single_quotes(tojson(node.tags))),
